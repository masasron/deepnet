...
commander
  .command('train <file>')
  .option('-t, --test-dataset-percentage <n>', 'percentage of datasets to keep for testing',parseInt,20)
  ...
  .option('-H, --hidden-layers <n>','number of hidden layers', parseInt)
  .option('-i, --iterations <n>','maximum number of iterations', parseInt, 20000)
  .option('-p, --log-period <n>','log progress every <n> iterations', parseInt)
